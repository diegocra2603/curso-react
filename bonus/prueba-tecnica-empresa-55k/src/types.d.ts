...
export class Convert {
    public static toUsersAPI(json: string): UsersAPI {
        return cast(JSON.parse(json), r("UsersAPI"));
    }

    public static usersAPIToJson(value: UsersAPI): string {
        return JSON.stringify(uncast(value, r("UsersAPI")), null, 2);
    }
}
